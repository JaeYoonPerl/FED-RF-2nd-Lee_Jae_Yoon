...
mFn.addEvt(cta3,"change",()=>{
    ...
    // 이것을 value에 할당하면 선택박스값이 첫번째로 변경된다.
    sel3.value = "0";
}); /////////// change 이벤트 함수 /
...
function sortingFn(evt, cta, arrData, exBox) {
  ...
  console.log("검색결과 변수값:",searchResult);
...
// searchResult값에 할당되어 true이면 이 값을 보내고 
// 아니면 원본 list2를 보낸다.
...
// 5-2. 객체데이터를 값배열로 변환하여 리스트 생성함수에 보내어 리스트 화면 출력하기
