// 구체적인 데이터 구성 처리를 위한 JS : msg_format.js
...
// 4. 화살표함수를 만들고 함수 앞에서 export default하기
// -> 내보내기 할때 함수명이 중요하지 않으므로 
// 화살표함수로 내보내기를 해도 무관하다.
// 이때 화살표 함수는 리턴 키워드 생략이 가능할 경우 이를 생략한다.
