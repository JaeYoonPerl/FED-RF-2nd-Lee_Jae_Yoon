...
// [비례식을 세운다]
// 스크롤한계값 : 윈도우높이 = 스크롤 이동값 : 이미지 이동값
// 이미지이동값 = 윈도우높이 * 스크롤 이동값 / 스크롤한계값
...
function moveWoman() {
    ...
    // 이미지이동값 = 윈도우높이(winH) * 스크롤 이동값(scTop) / 스크롤한계값(scLlimit)
