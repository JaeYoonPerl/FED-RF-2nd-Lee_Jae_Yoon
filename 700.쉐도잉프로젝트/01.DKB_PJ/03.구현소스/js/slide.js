...
******************************************/
    function loadFn() {
        ...
        function goSlide(evt, sts = true) {
            ...
            // 함수에 전달변수 하나를 쓸 경우 또는
            // 여러 전달변수중 첫번째 변수는 이벤트 객체가 전달된다.
            console.log("전달변수:", evt, sts);

            // 만약 버튼 클릭일 경우 인터벌지우기함수 호출!
            if (sts) {
                clearAuto();
            } ////// if
            ...
            // sts값이 true냐? 맞으면 버튼을 클릭한것이므로
            // this 키워드에 의한 클래스. ab2 존재여부를 물어라
            ...
            // 2-2. 왼쪽 버튼일 경우
                ...
                // 시간차는 어쩌죠? 0을 줘도 코드를
                // 분리하여 처리하므로 동시처리가 아니고 비동기처리하기 때문에 코드가 잘 작동한다.
                setTimeout(() => {
