...
export default function Board() {
    ...
    // -> 기존 셋팅값에 1을 곱하면 원래값, -1을 곱하면 반대값 셋팅
    ...
    return (
        <main className="cont">
            <h1 className="tit">OPINION</h1>
            {
                ...
                mode == "L" && <ListMode bindList={bindList} totalCount={totalCount} unitSize={unitSize} pageNum={pageNum} setPageNum={setPageNum} pgPgNum={pgPgNum} pgPgSize={pgPgSize} keyword={keyword} setKeyword={setKeyword} sort={sort} setSort={setSort} sortCta={sortCta} setSortCta={setSortCta} />
            }
            {
    ...
    return (
        <>
            <div className="selbx">
                ...
                {/* 정렬기준선택박스 */}
                <select name="sort_cta" id="sort_cta" className="sort_cta" onChange={(e) => setSortCta(e.target.value)} style={{ float: "right", translate: "0 5px" }}>
            ...
            <table className="dtblview readone">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Attachment</td>
                        <td>
                            {/* 파일정보를 하위 컴포넌트에서 상위 컴포넌트 변수인 uploadfile에 저장한다 */}
