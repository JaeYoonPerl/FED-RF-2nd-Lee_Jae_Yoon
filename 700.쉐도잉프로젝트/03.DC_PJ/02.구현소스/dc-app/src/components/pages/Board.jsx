    ...
    const bindList = () => {
        ...
        return (
            ...
            selData.map((v, i) => (
                ...
                // 0 일때 출력
            <tr>
                <td colSpan="5">Thereis no data.</td>
            </tr>
            )
        );
    }; /////////// bindList 함수 /////////////////
    ...
    return (
        <main className="cont">
            <h1 className="tit">OPINION</h1>
            {
                ...
                mode == "L" && <ListMode bindList={bindList} totalCount={totalCount} unitSize={unitSize} pageNum={pageNum} setPageNum={setPageNum} pgPgNum={pgPgNum} pgPgSize={pgPgSize} setKeyword={setKeyword} />
            }
            {
