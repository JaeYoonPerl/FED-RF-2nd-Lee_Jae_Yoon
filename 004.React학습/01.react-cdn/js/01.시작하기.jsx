...
function MyFirstReact() {
    ...
    return (
        <React.Fragment>
            ...
            <img src="https://w7.pngwing.com/pngs/856/564/png-transparent-react-logo-javascript-front-and-back-ends-user-interface-others-miscellaneous-logo-symmetry-thumbnail.png" alt="리액트 로고" />
            <h2>
                [ 리액트란 무엇인가? ]
                <br />
                ...
                빠르고 쉽게 UI화면의 구성한다! <br /># 가상돔은 실제DOM을 변경하기전에 메모리상에서 구성하는 가짜 DOM이다! <br />
            ...
            <iframe width="100%" height="594" src="https://www.youtube.com/embed/05uFo_-SGXU?list=PLZKTXPmaJk8J_fHAzPLH8CJ_HO_M33e7-" title="React JS #1 강의 소개 - 초보자를 위한 리액트 강좌" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </React.Fragment>
    );
} /////// MyFirstReact 생성자함수 //////////
