...
function MakeImg({ isrc, ialt , icss, overFn,clickFn,itit, idName }) {
  // 리턴코드 : return 키워드 바로 뒤에 JSX태를 바로 이어쓰거나
  // 소괄호 시작부분을 같은 라인에 써야 에러가 나지 않는다.
  return (
  <img src={isrc} alt={ialt} style={icss} title={itit} id={idName} onMouseOver={overFn} onClick={clickFn}/>
  );
} ///////////// MakeImg 컴포넌트 ////////////////
